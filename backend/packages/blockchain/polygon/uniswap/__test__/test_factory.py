"""Tests for Polygon Uniswap factory functions - Real network tests."""
...
def test_get_factory_address_mumbai():
    """Test getting factory address for mumbai."""
    address = get_factory_address("mumbai")
    assert isinstance(address, str)
    assert address == NETWORKS["mumbai"]["factory"]
