...
def _resolve_token_symbol_from_address(token_address: str) -> Optional[str]:  # noqa: UP045
...
def get_balance_ethereum(account_address: str, token_address: Optional[str] = None) -> dict:  # noqa: UP045
    """
