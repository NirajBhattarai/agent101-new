...
from packages.blockchain.dex.abis.uniswapv2router import UNISWAP_V2_ROUTER_ABI
...
from packages.blockchain.dex.abis.uniswapv3router import UNISWAP_V3_ROUTER_ABI
