"""
httpx client integration for x402 Hedera payments.
"""
...
class HttpxHooks:
    """Event hooks for httpx to handle x402 payment required responses."""

    def __init__(self, client: x402HederaClient):
        self.client = client
    ...
    async def on_response(self, response: Response) -> Response:
        ...
        try:
            ...
            payment_header = await self.client.create_payment_header(
...
def x402_payment_hooks(
    ...
    """
    # Create x402HederaClient
    x402_client = x402HederaClient(
        client=client,
...
class x402HttpxClient(AsyncClient):
    """AsyncClient with built-in x402 Hedera payment handling."""
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """Initialize an AsyncClient with x402 Hedera payment handling.
        ...
        self.event_hooks = x402_payment_hooks(
            client, account_id, private_key, max_value, payment_requirements_selector
        )
